...
News Application - Django-based news platform with roles, subscriptions,
article approval workflow, signals, and REST API.
"""
...
SECRET_KEY = 'django-insecure-yahsw#)ze$9-*@@*0jm!0jsyx#urf%4^94othn8@=j65xi-9um'
...
TEMPLATES = [
    {
        ...
        # Look for templates in a project-level 'templates' directory
...
# -------------------------------------------------------------------
# Email backend - using console for development (no SMTP server needed)
# Replace with SMTP settings in production
# -------------------------------------------------------------------
